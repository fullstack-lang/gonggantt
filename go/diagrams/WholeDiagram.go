...
func NewDiagramInjection() {
	...
	__Link__000003_Lanes := (&models.Link{Name: `Lanes`}).Stage()
	__Link__000004_To := (&models.Link{Name: `To`}).Stage()
	...
	__Vertice__000003_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Gantt_and_NewDiagram_Lane := (&models.Vertice{Name: `Verticle in class diagram NewDiagram in middle between NewDiagram-Gantt and NewDiagram-Lane`}).Stage()
	__Vertice__000004_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Lane_and_NewDiagram_Bar := (&models.Vertice{Name: `Verticle in class diagram NewDiagram in middle between NewDiagram-Lane and NewDiagram-Bar`}).Stage()
	...
	__Field__000007_Name.Identifier = `ref_models.Group.Name`
	__Field__000007_Name.FieldTypeAsString = ``
	__Field__000007_Name.Structname = `Group`
	...
	__Field__000008_Name.Identifier = `ref_models.Arrow.Name`
	__Field__000008_Name.FieldTypeAsString = ``
	__Field__000008_Name.Structname = `Arrow`
	...
	__Field__000010_OptionnalColor.Identifier = `ref_models.Bar.OptionnalColor`
	__Field__000010_OptionnalColor.FieldTypeAsString = ``
	__Field__000010_OptionnalColor.Structname = `Bar`
	...
	__Field__000011_OptionnalColor.Identifier = `ref_models.Arrow.OptionnalColor`
	__Field__000011_OptionnalColor.FieldTypeAsString = ``
	__Field__000011_OptionnalColor.Structname = `Arrow`
	...
	__Field__000012_OptionnalStroke.Identifier = `ref_models.Arrow.OptionnalStroke`
	__Field__000012_OptionnalStroke.FieldTypeAsString = ``
	__Field__000012_OptionnalStroke.Structname = `Arrow`
	...
	__Field__000013_OptionnalStroke.Identifier = `ref_models.Bar.OptionnalStroke`
	__Field__000013_OptionnalStroke.FieldTypeAsString = ``
	__Field__000013_OptionnalStroke.Structname = `Bar`
	...
	__GongStructShape__000000_NewDiagram_Arrow.ShowNbInstances = true
	__GongStructShape__000000_NewDiagram_Arrow.NbInstances = 1
	...
	__GongStructShape__000001_NewDiagram_Bar.ShowNbInstances = true
	__GongStructShape__000001_NewDiagram_Bar.NbInstances = 4
	...
	__GongStructShape__000002_NewDiagram_Gantt.ShowNbInstances = true
	__GongStructShape__000002_NewDiagram_Gantt.NbInstances = 1
	...
	__GongStructShape__000003_NewDiagram_Group.ShowNbInstances = true
	__GongStructShape__000003_NewDiagram_Group.NbInstances = 1
	...
	__GongStructShape__000005_NewDiagram_LaneUse.ShowNbInstances = true
	__GongStructShape__000005_NewDiagram_LaneUse.NbInstances = 5
	...
	__GongStructShape__000006_NewDiagram_Milestone.ShowNbInstances = true
	__GongStructShape__000006_NewDiagram_Milestone.NbInstances = 2
	...
	// Link values setup
	__Link__000003_Lanes.Name = `Lanes`
	__Link__000003_Lanes.Structname = `Gantt`
	
	// comment added to overcome the problem with the comment map association

	//gong:ident [ref_models.Gantt.Lanes]
	__Link__000003_Lanes.Identifier = `ref_models.Gantt.Lanes`
	__Link__000003_Lanes.Fieldtypename = `Lane`
	__Link__000003_Lanes.TargetMultiplicity = models.MANY
	__Link__000003_Lanes.SourceMultiplicity = models.ZERO_ONE

	// Link values setup
	__Link__000004_To.Name = `To`
	__Link__000004_To.Structname = `Arrow`
	
	// comment added to overcome the problem with the comment map association

	//gong:ident [ref_models.Arrow.To]
	__Link__000004_To.Identifier = `ref_models.Arrow.To`
	__Link__000004_To.Fieldtypename = `Bar`
	__Link__000004_To.TargetMultiplicity = models.ZERO_ONE
	__Link__000004_To.SourceMultiplicity = models.MANY

	// Position values setup
	__Position__000000_Pos_NewDiagram_Arrow.X = 240.000000
	__Position__000000_Pos_NewDiagram_Arrow.Y = 300.000000
	__Position__000000_Pos_NewDiagram_Arrow.Name = `Pos-NewDiagram-Arrow`

	// Position values setup
	__Position__000001_Pos_NewDiagram_Bar.X = 730.000000
	__Position__000001_Pos_NewDiagram_Bar.Y = 130.000000
	__Position__000001_Pos_NewDiagram_Bar.Name = `Pos-NewDiagram-Bar`

	// Position values setup
	__Position__000002_Pos_NewDiagram_Gantt.X = 40.000000
	__Position__000002_Pos_NewDiagram_Gantt.Y = 170.000000
	__Position__000002_Pos_NewDiagram_Gantt.Name = `Pos-NewDiagram-Gantt`

	// Position values setup
	__Position__000003_Pos_NewDiagram_Group.X = 470.000000
	__Position__000003_Pos_NewDiagram_Group.Y = 520.000000
	__Position__000003_Pos_NewDiagram_Group.Name = `Pos-NewDiagram-Group`

	// Position values setup
	__Position__000004_Pos_NewDiagram_Lane.X = 400.000000
	__Position__000004_Pos_NewDiagram_Lane.Y = 50.000000
	__Position__000004_Pos_NewDiagram_Lane.Name = `Pos-NewDiagram-Lane`

	// Position values setup
	__Position__000005_Pos_NewDiagram_LaneUse.X = 170.000000
	__Position__000005_Pos_NewDiagram_LaneUse.Y = 500.000000
	...
	__Vertice__000000_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Arrow_and_NewDiagram_Bar.X = 498.500000
	__Vertice__000000_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Arrow_and_NewDiagram_Bar.Y = 326.000000
	...
	// Vertice values setup
	__Vertice__000001_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Arrow_and_NewDiagram_Bar.X = 598.500000
	__Vertice__000001_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Arrow_and_NewDiagram_Bar.Y = 381.000000
	...
	// Vertice values setup
	__Vertice__000002_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Gantt_and_NewDiagram_Arrow.X = 155.000000
	...
	// Vertice values setup
	__Vertice__000003_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Gantt_and_NewDiagram_Lane.X = 415.000000
	__Vertice__000003_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Gantt_and_NewDiagram_Lane.Y = 171.000000
	__Vertice__000003_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Gantt_and_NewDiagram_Lane.Name = `Verticle in class diagram NewDiagram in middle between NewDiagram-Gantt and NewDiagram-Lane`

	// Vertice values setup
	__Vertice__000004_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Lane_and_NewDiagram_Bar.X = 760.000000
	__Vertice__000004_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Lane_and_NewDiagram_Bar.Y = 148.500000
	__Vertice__000004_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Lane_and_NewDiagram_Bar.Name = `Verticle in class diagram NewDiagram in middle between NewDiagram-Lane and NewDiagram-Bar`
	...
	__GongStructShape__000000_NewDiagram_Arrow.Fields = append(__GongStructShape__000000_NewDiagram_Arrow.Fields, __Field__000008_Name)
	__GongStructShape__000000_NewDiagram_Arrow.Fields = append(__GongStructShape__000000_NewDiagram_Arrow.Fields, __Field__000011_OptionnalColor)
	__GongStructShape__000000_NewDiagram_Arrow.Fields = append(__GongStructShape__000000_NewDiagram_Arrow.Fields, __Field__000012_OptionnalStroke)
	__GongStructShape__000000_NewDiagram_Arrow.Links = append(__GongStructShape__000000_NewDiagram_Arrow.Links, __Link__000002_From)
	__GongStructShape__000000_NewDiagram_Arrow.Links = append(__GongStructShape__000000_NewDiagram_Arrow.Links, __Link__000004_To)
	...
	__GongStructShape__000001_NewDiagram_Bar.Fields = append(__GongStructShape__000001_NewDiagram_Bar.Fields, __Field__000010_OptionnalColor)
	__GongStructShape__000001_NewDiagram_Bar.Fields = append(__GongStructShape__000001_NewDiagram_Bar.Fields, __Field__000013_OptionnalStroke)
	...
	__GongStructShape__000002_NewDiagram_Gantt.Links = append(__GongStructShape__000002_NewDiagram_Gantt.Links, __Link__000003_Lanes)
	__GongStructShape__000003_NewDiagram_Group.Position = __Position__000003_Pos_NewDiagram_Group
	__GongStructShape__000003_NewDiagram_Group.Fields = append(__GongStructShape__000003_NewDiagram_Group.Fields, __Field__000007_Name)
	__GongStructShape__000004_NewDiagram_Lane.Position = __Position__000004_Pos_NewDiagram_Lane
	__GongStructShape__000004_NewDiagram_Lane.Links = append(__GongStructShape__000004_NewDiagram_Lane.Links, __Link__000001_Bars)
	...
	__Link__000001_Bars.Middlevertice = __Vertice__000004_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Lane_and_NewDiagram_Bar
	__Link__000002_From.Middlevertice = __Vertice__000000_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Arrow_and_NewDiagram_Bar
	__Link__000003_Lanes.Middlevertice = __Vertice__000003_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Gantt_and_NewDiagram_Lane
	__Link__000004_To.Middlevertice = __Vertice__000001_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_Arrow_and_NewDiagram_Bar
}
