...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		...
		_controllerSingloton.Map_BackRepos[""] = gonggantt_orm.GetDefaultBackRepo()
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *gonggantt_orm.BackRepoStruct, stackPath string) {
