...
func (db *DBLite) Create(instanceDB any) (db.DBInterface, error) {
	if instanceDB == nil {
		return nil, errors.New("github.com/fullstack-lang/gonggantt/go, instanceDB cannot be nil")
	}
	...
	default:
		return nil, errors.New("github.com/fullstack-lang/gonggantt/go, unsupported type in Create")
	}
	return db, nil
}
...
func (db *DBLite) Delete(instanceDB any) (db.DBInterface, error) {
	...
	default:
		return nil, errors.New("github.com/fullstack-lang/gonggantt/go, unsupported type in Delete")
	}
	return db, nil
}
...
func (db *DBLite) Save(instanceDB any) (db.DBInterface, error) {
	...
	case *MilestoneDB:
		...
		return db, nil
	default:
		return nil, errors.New("github.com/fullstack-lang/gonggantt/go, Save: unsupported type")
	}
}
...
func (db *DBLite) First(instanceDB any, conds ...any) (db.DBInterface, error) {
	if len(conds) != 1 {
		return nil, errors.New("github.com/fullstack-lang/gonggantt/go, Do not process when conds is not a single parameter")
	}
	...
	case string:
		...
		if err != nil {
			return nil, errors.New("github.com/fullstack-lang/gonggantt/go, conds[0] is not a string number")
		}
	case uint64:
		i = cond
	case uint:
		i = uint64(cond)
	default:
		return nil, errors.New("github.com/fullstack-lang/gonggantt/go, conds[0] is not a string or uint64")
	}
