...
func SerializeStage(filename string) {
	...
	{
		// insertion point
		SerializeExcelize[Arrow](f)
		SerializeExcelize[Bar](f)
		SerializeExcelize[Gantt](f)
		SerializeExcelize[Group](f)
		SerializeExcelize[Lane](f)
		SerializeExcelize[LaneUse](f)
		SerializeExcelize[Milestone](f)
	}
