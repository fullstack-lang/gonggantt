  ...
  */
  ...
  setTableRouterOutletFromTree(path: string, type: GongNodeType, structName: string, id: number) {
    ...
    if (type == GongNodeType.STRUCT) {
      this.router.navigate([{
        outlets: {
          github_com_fullstack_lang_gonggantt_go_table: ["github_com_fullstack_lang_gonggantt_go-" + path.toLowerCase()]
        }
      }]);
    }
    ...
    if (type == GongNodeType.INSTANCE) {
      this.router.navigate([{
        outlets: {
          github_com_fullstack_lang_gonggantt_go_presentation: ["github_com_fullstack_lang_gonggantt_go-" + structName.toLowerCase() + "-presentation", id]
        }
      }]);
    }
  }
